...
def test_that_fixed_line_fragment_renders_each_line_of_a_given_line():
    given_text = "Hello, World!"

    expected_text = given_text + '   '
    given_fragment = [Pixel(char) for char in given_text]

    fragment = FixedLineFragment(given_fragment, len(expected_text))
...
def test_that_fixed_line_fragment_has_the_length_equals_the_given_text():
    given_fragment = [Pixel(' ')]

    assert len(FixedLineFragment(given_fragment, 1000)) == 1000


def test_that_fixed_line_fragment_deals_with_slices():
    given_text = "Hello, World"
    given_fragment = [Pixel(char) for char in given_text]
    given_empty_fragment = []

    fragment = FixedLineFragment(given_fragment, 100)
    empty_fragment = FixedLineFragment(given_empty_fragment, 0)
...
def test_that_fixed_line_fragment_deals_with_indexs():
    given_text = "Hello, World"
    given_fragment = [Pixel(char) for char in given_text]
...
def test_that_fixed_fragment_renders_each_line_of_a_given_line():
    expected_lines = [
...
def test_that_fixed_fragment_can_blocks_only_the_width():
    expected_lines = [
        [Pixel('a'), Pixel('b'), Pixel(' ')],
        [Pixel('c'), Pixel('d'), Pixel(' ')],
    ]
...
def test_that_fixed_fragment_works_with_slices_and_index():
    lines = [
...
def test_that_fixed_fragment_truncate_the_contant_if_it_exeeds_width_and_height():
    lines = [
        [Pixel('a'), Pixel('b'), Pixel(' ')],
...
def test_that_fixed_fragment_can_blocks_only_the_height_by_using_the_max_line_width():
    expected_lines = [
        [Pixel('a'), Pixel('b'), Pixel(' ')],
        [Pixel('c'), Pixel('d'), Pixel('e')],
        [Pixel('f'), Pixel(' '), Pixel(' ')],
...
def test_that_all_lines_of_fixed_fragment_is_equal_the_given_width():
    assert all(len(line) == 3 for line in FixedMatrixFragment([], height=3, width=3))


def test_that_when_a_fixed_is_called_by_index_it_always_returns_a_blocked_line():
    line = [
        [Pixel('a'), Pixel('b')],
        [Pixel('c'), Pixel('d'), Pixel('e')]
    ]

    assert list(FixedMatrixFragment(line)[0]) == [Pixel('a'), Pixel('b'), Pixel(' ')]